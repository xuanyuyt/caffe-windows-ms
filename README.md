- [x] copy from: [caffe-windows](https://github.com/happynear/caffe-windows/tree/ms/windows) 
# Caffe
...
### cuDNN
Download `cuDNN v7` [from nVidia website](https://developer.nvidia.com/cudnn).
...
Download Anaconda3 64-bit Windows installer
